...
USE_SPLIT = None
OUT_PATH = Path(fr"D:\audio_adv_experiment\datasets\torgo_fulllex_wrong_subset_multi_{USE_SPLIT}_results.csv")
...
print("\n=== Full-lexicon wrong-subset multi summary ===")
print(summary)

print("\n=== Full-lexicon rank change summary ===")
print(rank_change_summary)

print("\n=== Full-lexicon distance change summary ===")
