...
# Config
# =========================================================
CSV_PATH = Path(r"D:\audio_adv_experiment\datasets\torgo_50word_split_clean.csv")
#USE_SPLIT = "dev"   # 先跑 dev，之后改成 test
USE_SPLIT = None
OUT_PATH = Path(fr"D:\audio_adv_experiment\datasets\torgo_50word_wrong_subset_multi_{USE_SPLIT}_results.csv")
...
print("\n=== 50-word wrong-subset multi summary ===")
print(summary)

print("\n=== 50-word rank change summary ===")
print(rank_change_summary)

print("\n=== 50-word distance change summary ===")
